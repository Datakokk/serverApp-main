...
*       responses:
*           200:
*               description: 'json response {total customers: <integer>, customers: <customers-array>}'
*           404:
...
app.get('/:skip/:limit', tokenVerification, async (req, res, next) => {
    try {
        if(req.params.skip === undefined || req.params.limit === undefined) {
            throw new ErrorHandler(404, 'skip and limits params are mandatory')
        }
...
*       responses:
*           200:
*               description: 'json response {customers: <object>}'
*           404:
*               description: skip and limits params mandatory error
*           500:
*               description: general database error
...
app.get('/:_id', tokenVerification, async (req, res, next) => {
    try {
        if(req.params._id === undefined) {
            throw new ErrorHandler(404, '_id params is mandatory')
        }
